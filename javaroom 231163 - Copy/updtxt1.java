...
class updtxt1 { /* 1 - 631108 */  public static void main(String args[]) throws IOException {    String waitopt;
 ...
 for 1 character */      }    }  }/* 2 */  static void displaymenu () {    System.out.println("0 : bye bye");
    ...
    /* 3 */  public static void create5 () throws IOException {    
 ...
 */      Pattern pattern = Pattern.compile("&");
  ...
  /* 7 */  
  public static void editnamesalary () throws IOException {    BufferedReader stdin = new BufferedReader(new InputStreamReader(System.in));
  ...
  /* 9 */  public static void addnew () throws IOException {    BufferedReader stdin = new BufferedReader(new InputStreamReader(System.in));
    ...
    FileReader fin = new FileReader("updtxt.dat");
    BufferedReader bin = new BufferedReader (fin);    int i = 0, total = 0;
